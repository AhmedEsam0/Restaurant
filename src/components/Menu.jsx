  ...
  return (
    <div className="overflow-y-hidden overflow-x-hidden pb-[50px] sm:pt-[0px] sm:pb-[40px] md:py-[50px]">
      <div className="text-center">
        <p className="font-bold text-[25px] pt-[20px] sm:text-[16px]  md:text-[18px] lg:text-[21px] xl:text-[23px] leading-[30px] text-white">
        ...
        <div data-aos="fade-right" className="sm:w-[33%] md:w-[30%] lg:w-[30%]">
          ...
          <div className="flex flex-col sm:gap-3  lg:gap-5 xl:gap-4">
            <div>
              ...
              <div>
                <p className="font-normal text-[#aaaaaa]  text-[14px]  sm:text-[11px] md:text-[13px] lg:text-[16px]">
                  (Tomatoes, Olive oil, Basil leaves, Mozzarella cheese)
                </p>
              </div>
            </div>
            <div>
              ...
              <div>
                <p className="font-normal text-[#aaaaaa]  text-[14px]  sm:text-[11px] md:text-[13px] lg:text-[16px]">
                  (Ragu sauce, Golden tagliatelle pasta)
                </p>
              </div>
            </div>
            <div>
              ...
              <div>
                <p className="font-normal text-[#aaaaaa]  text-[14px]  sm:text-[11px] md:text-[13px] lg:text-[16px]">
                  (Ragu, Béchamel, Parmigiano, Sfoglia pasta)
                </p>
              </div>
            </div>
            <div>
              ...
              <div>
                <p className="font-normal text-[#aaaaaa]  text-[14px]  sm:text-[11px] md:text-[13px] lg:text-[16px]">
                  (Fried eggplant, Pacino sauce, Fresh basil, Caciocavallo
                  cheese)
                </p>
              </div>
            </div>
            <div>
              ...
              <div>
                <p className="font-normal text-[#aaaaaa]  text-[14px]  sm:text-[11px] md:text-[13px] lg:text-[16px]">
                  (creamy rice, Zafferano, Grana Padana cheese)
                </p>
              </div>
            </div>
          </div>
