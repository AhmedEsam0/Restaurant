...
const AboutUs = () => {
  ...
  return (
    <div
      className=" overflow-x-hidden aboutus py-[50px] sm:py-[0px] md:py-[80px] h-[150vh] sm:h-[100vh] relative flex flex-col sm:flex-row justify-between items-center"
      id="pages"
    >
      ...
      <img
        src={knife}
        alt=""
        className="absolute  top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[80px] sm:w-[45px] md:w-[60px] lg:w-[80px] py-[0px]"
      />
